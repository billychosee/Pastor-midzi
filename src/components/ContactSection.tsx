          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 flex flex-col justify-between">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-600">naomimidzi</p>
                  </div>
                </div>
            ...
            <div className="mt-8 pt-6 text-center border-t border-gray-100">
              <blockquote className="text-sm italic text-gray-700 mb-2">
                &ldquo;Behold all of you among the heathen, and marvel, for I
                will work a work in your days which all of you will not believe,
                though it be told you.&rdquo;
              </blockquote>
...
const FormSelect = ({ label, options }: { label: string; options: string[] }) => (
  <div>
    <label className="block text-sm font-medium text-gray-700 mb-1">
      {label}
    </label>
